...
function Explore() {
  const API_KEY = "QJLVOX8Q4FCOITTM";
  const searchKeyword = "AAPL"; // replace with the search keyword you want to use
  ...
  useEffect(() => {
    fetch(
      ...
      .then((data) => {
        //console.log(data.bestMatches); // do something with the search results
